...
export function PriceTicker() {
  ...
  return (
    <div className="sticky top-0 z-50 border-b border-white/10 bg-gray-900/95 backdrop-blur print:hidden">
      ...
      {/* Desktop-only FY bar — mirrors the mobile top bar's FY selector
          but only appears on lg+ since the mobile top bar already has
          one and desktop has no other top strip. Right-aligned to match
          where Settings/Logout used to live in the sidebar's line of
          sight. */}
      <div className="hidden items-center justify-end border-b border-white/5 px-4 py-1.5 lg:flex">
        <FySelector />
      </div>
