...
function initSchema(db: Database.Database) {
  db.exec(`
    ...
    -- In-app notifications — bell icon feed. Each row is a notification
    -- targeted at a specific role level (or all). Auto-generated by
    -- route handlers on key events (deal approved, dispatch complete,
    -- session kicked, etc.).
